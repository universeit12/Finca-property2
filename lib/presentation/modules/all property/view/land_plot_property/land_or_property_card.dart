...
import 'featured_land_or_property_all_screen.dart';


class LandOrPlotPropertyCard extends StatelessWidget {
  LandOrPlotPropertyCard({super.key});
        ...
        return CustomCard(
          child: Column(
            children: [
              ...
              SeeAllLine(propertyTitle: "Land/Plot Property",onTap: (){
                Get.to(()=>AllLandOrPlotPropertyScreen());
              },),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return property.property!.mainPropertyTypeName == "Land/Plot"?InkWell(
                      onTap: () {
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CustomColumnText(property.property!.sizeKatha.toString(),"Size (Katha)"),

                                      CustomColumnText(property.property!.handoverDate.toString(),"Handover Date"),
                                    ],
                                  ),
  ...
  Widget CustomColumnText(String property,String text) {
                          return Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5,),
                                    Text(property!="null"?property.toString():"",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 12),),
                                  ],
                                );
  }
}