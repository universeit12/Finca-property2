...
class ResidentialPropertyCard extends StatelessWidget {
  ResidentialPropertyCard({super.key});
        ...
        return CustomCard(
          child: Column(
            children: [
              ...
              SeeAllLine(propertyTitle: "Residentials Property",onTap: (){
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return property.property!.mainPropertyTypeName == "Residential"?InkWell(
                      onTap: () {
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CustomColumnText(property.property!.bedroom.toString(),"Bedrooms"),
                                      CustomColumnText(property.property!.bathroom.toString(),"Baths"),
                                      CustomColumnText(property.property!.bedroom.toString(),"Size (Sq.fit)"),
                                    ],
                                  ),
